...
import numpy as np
import sub_transforms as transforms
...
优化后的数据集类
"""
# from Sub_Tools.AT_dataset import NewBsdsDataset
...
class BsdsDataset(Dataset):
    def __init__(self, dataset_path="", flag="train", sub_sample=-1):
        ...
        if self.flag == "train":
            ...
            print("test image num: ", len(self.img_list), "test label num: ", len(self.lbl_list))
        print("dataset load time: ", time.time() - t1)

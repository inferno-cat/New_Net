...
from new_edge_08 import Conv2d, EdgeConv, CPDCBlock, MixBlock, LineMixBlock
...
from Sub_Tools.AT_GEMA import EnhancedEMA as AT_GEMA
...
class FuseDecoder(nn.Module):
    def __init__(self, in_channels):
        super(FuseDecoder, self).__init__()
...
class PDCNet(nn.Module):
    def __init__(self, base_dim=16):
        ...
        self.de3 = FuseDecoder(self.in_channels[2])
        self.de2 = FuseDecoder(self.in_channels[1])
        self.de1 = FuseDecoder(self.in_channels[0])
        ...
        self.up4 = AT_UpSample2(self.in_channels[3], self.in_channels[2], scale=2)
        self.up3 = AT_UpSample2(self.in_channels[2], self.in_channels[1], scale=2)
        self.up2 = AT_UpSample2(self.in_channels[1], self.in_channels[0], scale=2)
